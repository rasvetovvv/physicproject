...
const code = `class physicProject
{
    private mark $mark;
...
const tabs = [
  { name: 'physicProject.php', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Проєкт з фізики для файної оцінки надіємося
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/">Розпочнемо</Button>
                <Button href="https://github.com/rasvetovvv" variant="secondary">
                  ГітХаб розробника
                </Button>
              </div>
            </div>
